...
const Page = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-12">
      ...
      <p className="mt-4 text-xl font-semibold text-gray-200">Access Denied</p>
      <p className="mt-2 text-gray-300">Sorry, You cant acces this page without having Admin Autorities</p>
